...
END $$
      ...
      CALL CrearUsuario('da', '123456', 'Administrador');
...
SELECT * FROM USUARIOS
CALL spu_usuarios_actualizar_clave(51, 'Ca', '$2y$10$EauxzNplzGb1A4I4jjtXAeo/fMlk3Zvm4dp70TDBBX29Tt51tZyBG');
...
VALUES (1, 'Lunes', '52 segundos', '08:00:00', '2023-12-30', 'Observaciones para el primer contrato'),
       (1, 'Martes', '52 segundos', '20:00:00', '2023-12-31', 'Observaciones para el segundo contrato');
...
VALUES
    (1, 'yape',500.00, 20.00, 440.00, 60.00, '2023-12-28', 'cuota inicial 50%', 'pendiente');	
...
CALL ActualizarPagosContrato(1, 'TipoPago', 150.50, 'Descripción Actualizada', '');
